...
# POST 데이터 처리 후 항상 HttpResponseRedirect로 사용자가 뒤로가기 버튼을 눌렀을 때, 중복으로 전달되는 것을 방지한다.

def detail(request, question_id):
    question = get_object_or_404(Question, pk=question_id) # pk = 고유키
