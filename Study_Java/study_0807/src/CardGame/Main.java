...
public class Main {
	public static void main(String[] args) {
		...
		Computer player1 = new Computer("컴1");
		Computer player2 = new Computer("컴2");
		...
		if (hr1 == 1) {
			...
			System.out.println(player2.name + "이 Player 2가 히든 룰로 승리하였습니다.");
		} else if (score1 > score2) {
			System.out.println(player1.name + "이 승리하였습니다.");
		} else if (score1 < score2) {
			System.out.println(player2.name + "이 승리하였습니다.");
		} else {
